...
def HardSphereEDMD(positions, velocities, L, R, num, steps):
    ...
    for s in range(steps):
        ...
        # print(statetf[0,0])
        # if s% 50 == 0:
            # disk_plot(statetf[:,1:3], L, R,f"/Users/mattkafker/Documents/WPP/HardSphereSimulations/EventsBasedSimulations/temp/{s}.png")
    ...
    return ed, ec, particle2cell,cell2particle, state, [[round(x[0]),round(x[1]),x[2]] for x in collisions[:collcounter]], allstates
